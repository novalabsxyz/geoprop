...
//         assert_approx_eq!(i0.x(), p1.x(), 1.0e-6);
//         assert_approx_eq!(i0.y(), p1.y(), 1.0e-6);
//         assert_approx_eq!(i100.x(), p2.x(), 1.0e-6);
//         assert_approx_eq!(i100.y(), p2.y(), 1.0e-6);
//     }
...
//         assert_approx_eq!(i20.x(), i20_should.x(), 0.2);
//         assert_approx_eq!(i20.y(), i20_should.y(), 0.2);
//         assert_approx_eq!(i50.x(), i50_should.x(), 0.2);
//         assert_approx_eq!(i50.y(), i50_should.y(), 0.2);
//         assert_approx_eq!(i80.x(), i80_should.x(), 0.2);
//         assert_approx_eq!(i80.y(), i80_should.y(), 0.2);
//     }
...
//         assert_approx_eq!(i50.x(), i50_should.x(), 1.0e-6);
//         assert_approx_eq!(i50.y(), i50_should.y(), 1.0e-6);
//     }
